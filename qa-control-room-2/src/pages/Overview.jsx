...
import { overviewFallback } from "../data/mockData.js";
import { useApiData } from "../hooks/useApiData.js";
import { api } from "../api/client.js";

export default function Overview() {
  const { data } = useApiData(api.getOverview, overviewFallback);
  const { riskScore, riskFactors, riskFactorsFooter, atAGlance } = data;
